...
# Define preprocess for the training and test sets
...
#dog_indices, deer_indices, airplane_indices, automobile_indices, bird_indices, cat_indices, frog_indices, horse_indices, ship_indices, truck_indices, other_indices = [] ,[], [], [], [], [], [], [], [], [], []
#dog_idx, deer_idx, airplane_idx, automobile_idx, bird_idx, cat_idx, frog_idx, horse_idx, ship_idx, truck_idx = train_set.class_to_idx['dog'], train_set.class_to_idx['deer'], train_set.class_to_idx['airplane'], train_set.class_to_idx['automobile'], train_set.class_to_idx['bird'], train_set.class_to_idx['cat'], train_set.class_to_idx['frog'], train_set.class_to_idx['horse'], train_set.class_to_idx['ship'], train_set.class_to_idx['truck']
...
#dog_indices = dog_indices[:int(0.1 * len(dog_indices))]
#deer_indices = deer_indices[:int(0.1 * len(deer_indices))]
#airplane_indices = airplane_indices[:int(0.1 * len(airplane_indices))]
#automobile_indices = automobile_indices[:int(0.1 * len(automobile_indices))]
#bird_indices = bird_indices[:int(0.1 * len(bird_indices))]
#cat_indices = cat_indices[:int(0.1 * len(cat_indices))]
#frog_indices = frog_indices[:int(0.1 * len(frog_indices))]
#horse_indices = horse_indices[:int(0.1 * len(horse_indices))]
#ship_indices = ship_indices[:int(0.1 * len(ship_indices))]
#truck_indices = truck_indices[:int(0.1 * len(truck_indices))]

#train_set = Subset(train_set, dog_indices+deer_indices+airplane_indices+automobile_indices+bird_indices+cat_indices+frog_indices+horse_indices+ship_indices+truck_indices+other_indices)
...
#dog_indices, deer_indices, airplane_indices, automobile_indices, bird_indices, cat_indices, frog_indices, horse_indices, ship_indices, truck_indices, other_indices = [], [], [], [], [], [], [], [], [], [], []
#dog_idx, deer_idx, airplane_idx, automobile_idx, bird_idx, cat_idx, frog_idx, horse_idx, ship_idx, truck_idx = test_set.class_to_idx['dog'], test_set.class_to_idx['deer'], test_set.class_to_idx['airplane'], test_set.class_to_idx['automobile'], test_set.class_to_idx['bird'], test_set.class_to_idx['cat'], test_set.class_to_idx['frog'], test_set.class_to_idx['horse'], test_set.class_to_idx['ship'], test_set.class_to_idx['truck']
...
#test_set = Subset(train_set, dog_indices+deer_indices+airplane_indices+automobile_indices+bird_indices+cat_indices+frog_indices+horse_indices+ship_indices+truck_indices+other_indices)
...
train_set = torchvision.datasets.ImageFolder(root = train_data_path, transform = preprocess)
test_set = torchvision.datasets.ImageFolder(root = test_data_path, transform = preprocess)
